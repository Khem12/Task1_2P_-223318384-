...
public class SeleniumOperations {
	...
	public static void open_chrome_loadpage_resize_close() {
		...
		System.out.println("Hello from <223318384>, <Khem Raj Gurung>");
		 ...
		 */
		Dimension miniwindow = new Dimension(640, 480);
		driver.manage().window().setSize(miniwindow);
		sleep(2);
		
		/*
		 * Double window size manually to 1280x960 and wait 2 second.		 
		 */
		Dimension maxwindow = new Dimension(1280, 960);
		driver.manage().window().setSize(maxwindow);
		sleep(2);
